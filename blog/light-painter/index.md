...
Using the trigonometric identities \\(\sin(t - 90 \deg) = -\cos(t)\\) and \\(\cos(t - 90 \deg) = \sin(t)\\), this becomes \\(\vec P(\theta) = \left\langle -A \cos(\theta) n\_2, A \cos(\theta) n\_1, A \sin(\theta) \right\rangle\\).
